      ...
      <div className="w-full max-w-md rounded-2xl bg-zinc-900 text-zinc-100 shadow-xl">
        ...
        <div className="flex items-center justify-between border-b border-zinc-700 px-6 py-4">
          <h2 className="text-xl font-semibold">
            {temaGroup.nome}
            <span className="ml-2 text-sm text-zinc-400">{temaGroup.descricao}</span>
          </h2>
        ...
        <div className="p-6 space-y-2">
          ...
          <Link href={`/temas/${temaGroup.slug}`} onClick={onClose} className="mt-4 inline-block text-sm text-blue-400 hover:underline">
            Ver tema completo →
          </Link>
        </div>
